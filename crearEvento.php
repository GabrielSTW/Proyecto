...
<meta name="theme-color" content="#563d7c">
  ...
  <body background="media/img/evento2.jpg" reponsive>
...
<div class="row">
  ...
  <div class="col-6">
    <h1 >Crear Evento</h1>
    <form action="crearEventodb.php" method="POST">
      <div class="form-group">
        <label for="formGroupDescripcion">Nombre del evento</label>
        <input type="text" class="form-control" id="formGroupDescripcion" name="descripcion" placeholder="Descripcion del evento" required>
        <br>
