        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item dropdown" href="#">Tabla Pedidos</a>
              <?php
              if ($_SESSION['nivel'] == 2)
              {
              ?>
    ...
    <table class="table table-striped table-dark">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="btn btn-warning" href="editarRegistros.php?id=<?php echo $fila['id'];?>" role="button">Editar</a></td>
            <td><a class="btn btn-danger" href="eliminarRegistros.php?id=<?php echo $fila['id'];?>" onclick="return confirm('Estas seguro de eliminar este registro')" role="button">Eliminar</a></td>
              <?php
              }
              ?>
          </tr>
      ...
      <div class="col-12">
        <?php
          if(isset($_GET['Bien'])) //Si existe la variable Bien
          {
          ?>
          ...
          <?php
           ...
           <?php
             if(isset($_GET['mal'])) //Si existe la variable Bien
             {
             ?>
