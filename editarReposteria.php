...
<div class="row">
  ...
  <div class="col-6">
    ...
    require("conexion.php");
      ...
      $sentencia = $mbd -> prepare("SELECT * FROM reposteria WHERE id=?");
      $sentencia2 = $mbd -> prepare("SELECT * FROM eventos");
    ...
    <h1 >Editar Reposteria</h1>
    <form action="editarReposteriadb.php" method="POST" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <label for="inputID">Pasteleria</label>
        <input type="text" id="inputName" name="pasteleria" class="form-control" placeholder="pasteleria" value="<?php echo $registro['pasteleria'];?>" required autofocus>
        <label for="inputName" >Descripcion</label>
        <input type="text" id="inputName" name="articulo" class="form-control" placeholder="articulos" value="<?php echo $registro['descripcion'];?>" required autofocus>
        <br>
        <div class="form-group">
            ...
            <select class="form-control" id="exampleFormControlEventos" name="eventosID">
              ...
              <option value="<?php echo $fila['evento_id']; ?>"> <?php echo $fila['descripcion'];?> </option>
              <?php
               }
              ?>
            </select>
