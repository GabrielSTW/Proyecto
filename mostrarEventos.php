        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item dropdown" href="#">Tabla Eventos</a>
              <?php
              if ($_SESSION['nivel'] == 1)
              {
              ?>
...
<main role="main" class="container">
  ...
  require("conexion.php");
    ...
    <center><h1> Tabla de Categorias </h1></center>
    <table class="table table-striped table-dark">
        ...
        <tbody>
          ...
          <tr>
            ...
            {
            ?>
            <td><a class="btn btn-warning" href="editarEventos.php?id=<?php echo $fila['Id'];?>" role="button">Editar</a></td>
            <td><a class="btn btn-danger" href="eliminarEvento.php?id=<?php echo $fila['Id'];?>" onclick="return confirm('Estas seguro de eliminar este registro')" role="button">Eliminar</a></td>
            <?php
            }
            ?>
          </tr>
