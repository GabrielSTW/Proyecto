    ...
    <table class="table table-striped table-dark">
        ...
        <tbody>
          ...
          <tr>
            ...
            {
            ?>
            <td><a class="btn btn-warning" href="editarReposteria.php?id=<?php echo $fila['Id'];?>" role="button">Editar</a></td>
            <td><a class="btn btn-danger" href="eliminarReposteria.php?id=<?php echo $fila['Id'];?>" onclick="return confirm('Estas seguro de eliminar este registro')" role="button">Eliminar</a></td>
            <?php
            }
            ?>

            <td><img height="50 px" src="data:image/jpg;base64,<?php base64_encode($fila['Imagen'])?>"></td>
